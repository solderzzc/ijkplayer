...
import tv.danmaku.ijk.media.example.widget.media.filter.GlFilter;
import tv.danmaku.ijk.media.example.widget.media.filter.GlLookUpTableFilter;
import tv.danmaku.ijk.media.example.widget.media.filter.GlPreviewFilter;
...
class EPlayerRenderer extends EFrameBufferObjectRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    private final SurfaceRenderView glPreview;

    private float aspectRatio = 1f;

    EPlayerRenderer(SurfaceRenderView glPreview) {
        super();
